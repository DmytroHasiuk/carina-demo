...
@RequestTemplatePath(path = "api/github/_patchUpdateAutUser/rq.json")
@ResponseTemplatePath(path = "api/github/_patchUpdateAutUser/rs.json")
@SuccessfulHttpStatus(status = HttpResponseStatusType.OK_200)
public class PatchUpdateAutUser extends AbstractApiMethodV2 {

    public PatchUpdateAutUser() {
