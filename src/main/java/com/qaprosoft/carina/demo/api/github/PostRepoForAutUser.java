...
@RequestTemplatePath(path = "api/github/_postAutUserRepo/rq.json")
@ResponseTemplatePath(path = "api/github/_postAutUserRepo/rs.json")
@SuccessfulHttpStatus(status = HttpResponseStatusType.CREATED_201)
public class PostRepoForAutUser extends AbstractApiMethodV2 {

    public PostRepoForAutUser() {
