...
@Endpoint(url = "${base_url}/repos/DmytroHasiuk/Work-with-issues/issues/4/lock", methodType = HttpMethodType.DELETE)
@SuccessfulHttpStatus(status = HttpResponseStatusType.NO_CONTENT_204)
public class DeleteAnIssue extends AbstractApiMethodV2 {

    public DeleteAnIssue() {
